...
export default function AboutMe({ section, triggered }) {
        ...
        <Grid.Row>
          ...
          <Grid.Column mobile={16} computer={7}>
            ...
            >
              ...
              <p>I'm a multi-instrumentalist music producer focused on the fusion of electronic music with ethnic and tribal instruments.</p>
              <p>My travels through different cultures and the connection with shamanism are fully present and the essence of my music.</p>
            </div>

            <div
              id='about-final-quote'
              className={
                section === 'about-me'
                  ? 'animate-into-view'
                  : triggered
