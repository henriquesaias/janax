  ...
  return (
    <section id="experience">
      ...
      <div className="soundcloud-playlist">
        <iframe
          onFocus={() => alert('clicked')}
          width="100%"
          height="400"
          scrolling="no"
          frameBorder="no"
          allow="autoplay"
          src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/1260178069&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=false"
        >
        </iframe>
      </div>
    </section>
